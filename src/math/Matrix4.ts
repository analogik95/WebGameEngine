 ...
 * Used for representing position, rotation, and scale transformations
 * Stored in column-major order to match WebGL
 */
export class Matrix4 {
  ...
  /**
   * Sets this matrix from position, rotation (quaternion), and scale
   */
  ...
  /**
   * Decomposes this matrix into position, rotation, and scale
   */
  decompose(position: Vector3, quaternion: Quaternion, scale: Vector3): void {
    ...
    this.quaternionFromRotationMatrix(matrix, quaternion);
   ...
   */
  private quaternionFromRotationMatrix(m: Matrix4, q: Quaternion): void {
    const te = m.elements;
